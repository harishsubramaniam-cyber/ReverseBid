...
from ..security import (SESSION_COOKIE, current_user, current_user_optional, hash_password,
...
def login(request: Request, email: str = Form(""), password: str = Form(""),
    ...
    response.set_cookie(SESSION_COOKIE, make_session(user.id), httponly=True,
